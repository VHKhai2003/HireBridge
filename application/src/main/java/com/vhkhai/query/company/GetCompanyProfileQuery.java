...
public class GetCompanyProfileQuery implements Query<CompanyResponseDto> {
}

@Component
@RequiredArgsConstructor
class GetCompanyProfileQueryHandler implements Query.Hanldler<GetCompanyProfileQuery, CompanyResponseDto> {
