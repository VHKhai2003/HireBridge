package com.vhkhai.query.candidate.handler;
...
public class GetCandidateProfileQueryHandler implements Query.Hanldler<GetCandidateProfileQuery, CandidateResponseDto> {
